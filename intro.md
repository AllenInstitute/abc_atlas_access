...
## Release Notes
* **[Summer 2024 Public Beta (version 20240930) ab_atlas_access (v0.2.0)]**
  ...
  * Updated cache object for better compatiblity across platforms.
    ...
    * Modifed cache to autodetect cache type (local or s3) for easier
      compatiblity with CodeOcean/s3fs-fuse mounts.
